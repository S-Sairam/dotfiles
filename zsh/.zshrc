...
export SUDO_PROMPT="Deploying root access for %u. Enter your code: "
...
alias cdwm='cd ~/dwm-btw ;sudo nvim config.h ; cd -'
...
# Control left right binds 
# Bind Ctrl+Left/Right to move by words
...
pgrep -x "dwmblocks" > /dev/null || (nohup dwmblocks > /dev/null 2>&1 &)
